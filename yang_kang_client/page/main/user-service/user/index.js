...
function addListeners() {
    ...
    $('#btn-add').on('click', event => {
        ...
        $('#form-modal-title').text('Thêm Người Dùng');
    });
    ...
    $('#btn-edit').on('click', event => {
        ...
        $('#form-modal-title').text('Cập nhật Người Dùng');
    ...
    $('#btn-delete').on('click', function (event) {
        $('#delete-modal-title').text('Xóa Người Dùng');
        const message = `Bạn chắc chắn muốn xóa ${$('.selected').length} Người Dùng?`;
